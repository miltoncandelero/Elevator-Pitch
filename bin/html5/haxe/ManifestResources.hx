...
@:keep @:bind #if display private #end class __ASSET__img_bgrails_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__img_char2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__img_elevator_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/img/bgrails.png") #if display private #end class __ASSET__img_bgrails_png extends lime.graphics.Image {}
@:image("assets/img/char2.png") #if display private #end class __ASSET__img_char2_png extends lime.graphics.Image {}
...
@:image("assets/img/elevator.png") #if display private #end class __ASSET__img_elevator_png extends lime.graphics.Image {}
