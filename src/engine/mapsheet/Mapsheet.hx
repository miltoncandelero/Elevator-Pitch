package engine.mapsheet;

import engine.mapsheet.data.Behavior;
import engine.mapsheet.data.Frame;
...
class Mapsheet extends Tileset {
	 ...
	 * @param	offsetx When drawing this frame: Should we move it from the right a bit?
	 * @param	offsety When drawing this frame: Should we move it from the top a bit?
